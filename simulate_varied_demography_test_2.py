...
#SBATCH --job-name=dfe_sim_varied_demog_2e6_contig_1B08_test_small_2
...
pickle.dump(test_dict, open('data/test_data_1B08_varied_test_small_2.pickle', 'wb'))
    
with mp.Pool() as pool:
    train = pool.map(simulate_ts, arg_list_train)
train_dict = dict(zip(arg_list_train, train))
pickle.dump(train_dict, open('data/train_data_1B08_varied_test_small_2.pickle', 'wb'))
