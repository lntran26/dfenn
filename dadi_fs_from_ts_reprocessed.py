...
for i, ts in enumerate(test_data.values()):
    for max_snps_count in ['all']:
        ...
        # if not os.path.exists(f'data/dadi_test/two_epoch_varied_1B08/{max_snps_count}_scale_2'):
        #     os.makedirs(f'data/dadi_test/two_epoch_varied_1B08/{max_snps_count}_scale_2')
        # if not os.path.exists(f'data/dadi_test/two_epoch_varied_1B08/{max_snps_count}_scale_10'):
        #     os.makedirs(f'data/dadi_test/two_epoch_varied_1B08/{max_snps_count}_scale_10')
        if not os.path.exists(f'data/dadi_test/two_epoch_varied_1B08/{max_snps_count}_no_scale_wider_param_range'):
            os.makedirs(f'data/dadi_test/two_epoch_varied_1B08/{max_snps_count}_no_scale_wider_param_range')
        ...
        # neu_fs.to_file(f'data/dadi_test/two_epoch_varied_1B08/{max_snps_count}_scale_2/fs_{i}_syn')
        # non_neu_fs.to_file(f'data/dadi_test/two_epoch_varied_1B08/{max_snps_count}_scale_2/fs_{i}_nonsyn')
        # neu_fs.to_file(f'data/dadi_test/two_epoch_varied_1B08/{max_snps_count}_scale_10/fs_{i}_syn')
        # non_neu_fs.to_file(f'data/dadi_test/two_epoch_varied_1B08/{max_snps_count}_scale_10/fs_{i}_nonsyn')
        neu_fs.to_file(f'data/dadi_test/two_epoch_varied_1B08/{max_snps_count}_no_scale_wider_param_range/fs_{i}_syn')
        non_neu_fs.to_file(f'data/dadi_test/two_epoch_varied_1B08/{max_snps_count}_no_scale_wider_param_range/fs_{i}_nonsyn')
