...
#SBATCH --job-name=dfe_sim_exon_small_chunks_1_of_5
...
def simulate_ts(args):
    ...
    print(f"Simulating ts params: {args}")
...
arg_list_test = []
for param in list(test_data.keys())[:10]:
    gamma_mean = param[0]
    gamma_shape = param[1]
...
pickle.dump(test_dict, open('data/test_data_small_chunks_1_of_5.pickle', 'wb'))
